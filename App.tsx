...
export default function App() {
  ...
  if (!isLoaded || (session?.status === "active" && convexAuth.isLoading)) {
  ...
  if (!convexAuth.isAuthenticated) {
    return (
      ...
      >
        ...
        >
          Mindland could not open your private island data. Please reopen the
          app and try again.
        </Text>
      </View>
    );
  ...
  if (
    ...
    return <DevelopmentBackendProbe />;
  }
