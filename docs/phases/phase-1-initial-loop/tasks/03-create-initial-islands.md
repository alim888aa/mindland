...
Turn the interview result into the user’s first small, specific islands, place them coherently on the map, and reveal them with controls to rename or remove them. Split broad interests such as Health into the specific islands the user discusses, such as Fitness, Nutrition, and Sleep.
