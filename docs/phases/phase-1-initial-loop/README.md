...
The complete source, MIT license, judge setup instructions, testing path, architecture notes, and Codex/GPT-5.6 build story are published at https://github.com/alim888aa/mindland.
